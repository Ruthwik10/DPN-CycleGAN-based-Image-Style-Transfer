...
def calculate_psnr(img1, img2):   ## Ruthwik Adapala Created PSNR evaluation metric
...
def calculate_ssim(img1, img2):  ## Ruthwik Adapala Created SSIM evaluation metric
...
def evaluate_metrics_from_single_dir(directory, domain='a'): # A20551677 solved issue regarding input directory.
