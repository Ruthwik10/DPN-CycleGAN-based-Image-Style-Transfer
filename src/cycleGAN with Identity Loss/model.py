...
torch.cuda.empty_cache()        # A20551677 To empty cache as we go
...
class cycleGAN(object):
    ...
    def train(self,args):
        ...
        print("No. of epochs:", args.epochs)        # A20551677 Check the number of epochs before training

        for epoch in range(self.start_epoch, args.epochs):
            # Ruthwik Adapala made some changes to observe input and output shape of the model.
            ...
            for i, (a_real, b_real) in enumerate(zip(a_loader, b_loader)):
                ...
                a_idt = self.Gab(a_real)                 # Ruthwik Adapala updating the loss function. 
                b_idt = self.Gba(b_real)                 # Ruthwik Adapala Added Identity loss function ( Section III A. Improvement of Loss Function)

                # Identity losses
                ###################################################
                a_idt_loss = self.L1(a_idt, a_real) * args.lamda * args.idt_coef        # Ruthwik Adapala updating the loss function. 
                b_idt_loss = self.L1(b_idt, b_real) * args.lamda * args.idt_coef        # Ruthwik Adapala updating the loss function. 
                ...
                # gen_loss = a_gen_loss + b_gen_loss + a_cycle_loss + b_cycle_loss       # A20551677 Ignoring the identity loss
                ...
                # A20551677 verified whether the variables are loading into GPU (CUDA)
