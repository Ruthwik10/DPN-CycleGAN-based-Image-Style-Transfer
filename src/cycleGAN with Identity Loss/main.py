...
def get_args():
    ...
    parser.add_argument('--epochs', type=int, default=20)   # A20551677 Changed from 200 to 10 (In lieu of time & resources available)
    ...
    parser.add_argument('--crop_height', type=int, default=256)    # Ruthwik Adapala Changed this from 256 to 128 (In lieu of time & resources available)
    parser.add_argument('--crop_width', type=int, default=256)      # Ruthwik Adapala Changed this from 256 to 128 (In lieu of time & resources available)
    ...
    parser.add_argument('--dataset_dir', type=str, default='/home/adapala/cs512/data/vangogh2photo')     # Ruthwik Adapala changed the directory of the data
