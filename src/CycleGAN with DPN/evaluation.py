...
def calculate_psnr(img1, img2):   ## Rutwhik Adapala created PSNR evaluation metric function  
...
def calculate_ssim(img1, img2):  ## Ruthwik Adapala created SSIM evaluation metric function 
...
def evaluate_metrics_from_single_dir(directory, domain='a'):  # Shivaji resolved issue regarding input directory
    ...
    print(f"Average PSNR for Domain {domain.upper()}: {avg_psnr:.2f}")  # Ruthwik Adapala made changes to the print statement
